...
const UserLinks = () => {
    return (
       ...
       <li> <NavLink to={'/dashboard/user-home'} className="flex items-center justify-start gap-1"><FaHome className="text-black text-xl"/> <span className="text-black font-bold uppercase">user Home</span> </NavLink></li>
                 ...
                 <li> <NavLink to={'/dashboard/payment'} className="flex items-center justify-start gap-1"><GiWallet className="text-black text-xl"/> <span className="text-black font-bold uppercase"> payment history</span> </NavLink></li>
